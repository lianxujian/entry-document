  ...
  <div class="userMag">
    ...
    <div class="tab">
      <div class="left-tab">
        ...
        <!--showAll: '全部',绑定showAll默认显示是全部-->
        <!--用的单选钮的自带change事件-->
        <el-radio-group v-model="radio3" @change="select(radio3)">
          <el-radio-button label="全部"></el-radio-button>
          <el-radio-button label="会计"></el-radio-button>
          <el-radio-button label="外勤"></el-radio-button>
          <el-radio-button label="行政"></el-radio-button>
      ...
      <el-table align="center" :data="userData" style="width: 100%">
        ...
        <el-table-column align="center" label="操作" min-width="">
          ...
          <template scope="scope">
            <el-button type="text" style="width:40px;" @click="revise(true,scope.$index)">修改</el-button>
            <el-button type="text" style="width:40px;" @click="del(scope.$index)">删除</el-button>
        ...
        <div class="detail-main">
          <el-form label-width="80px" :model="formUser" ref="formUser">
            <el-form-item class="marginLeft" label="用户名" prop="userName" :rules="{ required: true,validator:checkUser,trigger: 'blur'}">
              <el-input v-model="formUser.userName" auto-complete="off" :disabled="isdisabled"></el-input>
            </el-form-item>
